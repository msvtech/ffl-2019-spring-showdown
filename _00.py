...
def main(startAt):
    ...
    ## 5if startAt <= 10 : wait_for_button_with_message('Dress Set');       m10_dress_the_set()
    ...
    if startAt <=  4 : wait_for_button_with_message('Stunt Work');      m06_stunt_work()
    if startAt <=  5 : wait_for_button_with_message('Costume');         m03_costume()
