...
def m10_dress_the_set():
    ...
    tank_drive.on_for_degrees(SpeedPercent(30), SpeedPercent(30), ratio_degrees_to_inches * 42.5, brake=True)
    ...
    tank_drive.on_for_degrees(SpeedPercent(-10), SpeedPercent(10), rotate * 100, brake=True)
