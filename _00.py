...
def main(startAt):
    ...
    if startAt <=  3 : wait_for_button_with_message('Dress Set');       m10_dress_the_set()
    if startAt <=  4 : wait_for_button_with_message('Deliver Movie');   m11_deliver_the_movie()
    # if startAt <=  5 : wait_for_button_with_message('CGI');             m07_cgi()
    ...
    # if startAt <=  8 : wait_for_button_with_message('Boom');            m02_microphone_boom()
    # if startAt <=  9 : wait_for_button_with_message('Move Set');        m04_move_the_set()
    # if startAt <= 10 : wait_for_button_with_message('Rigging');         m05_rigging()
    # if startAt <= 11 : wait_for_button_with_message('Camera');          m09_camera()
